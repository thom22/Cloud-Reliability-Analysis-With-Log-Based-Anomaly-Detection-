...
# Create React App Setup Script for HDFS Anomaly Detection Dashboard

echo "🚀 Setting up React Dashboard for HDFS Anomaly Detection..."

# Create new React app
npx create-react-app hdfs-dashboard
cd hdfs-dashboard
...
cat > src/HDFSAnomalyDashboard.js << 'EOF'
...
import HDFSAnomalyDashboard from './HDFSAnomalyDashboard';
import './App.css';

function App() {
  return <HDFSAnomalyDashboard />;
}
...
echo "2. In this directory run: npm start"
echo "3. The React dashboard will open on http://localhost:3000"
echo ""
echo "The dashboard will connect to your backend WebSocket and start showing real-time data!"